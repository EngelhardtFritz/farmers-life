...
public abstract class AbstractManualFluidMachineTileEntity<Recipe extends IRecipe<?>> extends AbstractManualMachineTileEntity<Recipe> implements IFluidHandler {
    private final FluidTank[] tanks;

    public AbstractManualFluidMachineTileEntity(TileEntityType tileEntityTypeIn, ITextComponent customName, int tankCount, int tankCapacity) {
