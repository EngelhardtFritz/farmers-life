...
public class WinePressRecipe implements IRecipe<RecipeWrapper> {
    public static final WinePressRecipe.WinePressRecipeSerializer WINE_PRESS_RECIPE_SERIALIZER = new WinePressRecipeSerializer();
    public static final ResourceLocation WINE_PRESS_ID = new ResourceLocation(FarmersLife.MOD_ID, "wine_press");
    ...
    public WinePressRecipe(ResourceLocation recipeId, Ingredient inputIngredient, int inputIngredientCount, FluidStack outputFluid, int processSteps) {
    ...
    public IRecipeSerializer<?> getSerializer() {
        return ModRecipeSerializer.WINE_PRESS_RECIPE_SERIALIZER.get();
    }

    @Nonnull
    @Override
    public IRecipeType<?> getType() {
        return Registry.RECIPE_TYPE.getValue(WINE_PRESS_ID).get();
    }
    ...
    public static class WinePressRecipeSerializer  extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<WinePressRecipe> {
        public static List<Item> ingredientList = new ArrayList<>();

        @Nonnull
        @Override
        public WinePressRecipe read(@Nonnull ResourceLocation recipeId, @Nonnull JsonObject json) {
            ...
            WinePressRecipe recipeToReturn = new WinePressRecipe(recipeId, inputIngredient, inputIngredientCount, outputFluid, processSteps);
        ...
        @Override
        public WinePressRecipe read(@Nonnull ResourceLocation recipeId, @Nonnull PacketBuffer buffer) {
            ...
            return new WinePressRecipe(id, inputIngredient, inputIngredientCount, outputFluid, processSteps);
        }

        @Override
        public void write(@Nonnull PacketBuffer buffer, WinePressRecipe recipe) {
